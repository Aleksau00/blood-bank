...
insert into app_user (username, password,  first_name, last_name, phone_number, umcn, gender, institution, role, address_id, points, is_locked, is_enabled,  loyalty_card_id, penalties) values ('perica@perica.com', '$2a$10$dDjrNg.RVyF4ozF/cr4auO3q6.AgihxSWUz.dqLI/OzoPZjSnXoji',  'Petar', 'Petrovic', '086745384', '1305994779876', 0,'FTN', 'registeredUser', 1, 1020, false, true, '1', 0);
insert into app_user (username, password,  first_name, last_name, phone_number, umcn, gender, institution, role, address_id, points, is_locked, is_enabled,  loyalty_card_id, penalties) values ('jelica@jelica.com', '$2a$10$dDjrNg.RVyF4ozF/cr4auO3q6.AgihxSWUz.dqLI/OzoPZjSnXoji', 'Jelena', 'Savic', '086745444', '1305994779876', 1,'FTN', 'registeredUser', 1, 1080, false, true,'1', 0);
insert into app_user (username, password,  first_name, last_name, phone_number, umcn, gender, institution, role, address_id, points, is_locked, is_enabled,  loyalty_card_id, penalties) values ('anica@anica.com', '$2a$10$dDjrNg.RVyF4ozF/cr4auO3q6.AgihxSWUz.dqLI/OzoPZjSnXoji',  'Ana', 'Jovanovic', '086745777', '1805994773344', 1,'Economy faculty in Novi Sad', 'registeredUser', 1, 3090, false, true, '2', 0);
