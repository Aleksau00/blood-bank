...
import { StaffProfileUpdateComponent } from "./modules/pages/staff-profile-update/staff-profile-update.component";
import { CenterUpdateComponent } from "./modules/pages/center-update/center-update.component";
...
const routes: Routes = [
  ...
  { path: 'staff-profile-update', component: StaffProfileComponent},
  { path: 'center-update', component: CenterComponent }
